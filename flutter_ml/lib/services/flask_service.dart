...
class FlaskService {
  ...
  String get _baseDirectory {
    ...
    String projectPath = exeDir;
    // Navigate up until we find the magnificent-three folder
    while (path.basename(projectPath) != 'the-magnificent-three' &&
        !path.basename(projectPath).isEmpty) {
